...
<body>
<?php
echo '<script>var pres = '.$_GET['pres'].';</script>';
echo '<script>var CHECK_CONNECTION = '.CHECK_CONNECTION.';</script>';
...
<?php
    if(PRES_ENABLED == true){
      //presentation
      if($_GET['pres'] > 0){
        echo '<a href="'.makeUrl($path).'&pres=0" id="buttonPresentation"
          onClick="window.open(this.href, \'_self\');">'.$text['presTurnOff'].'</a>.
          <span id="presText"><span id="presTextLeft"></span></span>.';
      }
      else{
        echo '
        <form method="GET" id="pres">
         <input type="hidden" name="path" value="'.$path.'">
         '.$text['presSeconds'].' <input name="pres" type="number" min="1" value="'.PRES_DEFAULT.'">
         <button type="submit" id="buttonPresentation" title="Zapnout automatický posun souborů"
          onclick="submit()">'.$text['presTurnOn'].'</button>
        </form>';
        //id="buttonPresentation" onClick="window.open(this.href, \'_self\');">'.$text['presTurnOn'].'</a>';
      }
    }
    $pathArray = explode("/", $path);
    ...
    if(is_array($files)){
      ...
      foreach($files as $key=>$value){
        if($path == str_replace("./", "", $value)){
          ...
          if($key != 0){
            $imgBefore0 = $files[0];
            $navigation .= '<a class="move" href="'.makeUrl($imgBefore0).'" id="buttonViewMoveFirst" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveFirst'].'</a> | ';
          }
          else{
          ...
          if($imgBefore10 != ''){
            $navigation .= '<a class="move" href="'.makeUrl($imgBefore10).'" id="buttonViewMoveJumpLeft" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveBefore10'].'</a> | ';
          }
          else{
          ...
          if($imgBefore != ''){
            $navigation .= '<a class="move" href="'.makeUrl($imgBefore).'" id="buttonViewMoveLeft" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveBefore1'].'</a>';
          }
          else{
          ...
          $imgNext = $files[$key+1];
          if($imgNext != ''){
            $navigation .= '<a class="move" href="'.makeUrl($imgNext).'" id="buttonViewMoveRight" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveNext1'].'</a>';
          }
          else{
          ...
          if($imgNext10 != ''){
            $navigation .= '&nbsp;|&nbsp;<a class="move" href="'.makeUrl($imgNext10).'" id="buttonViewMoveJumpRight" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveNext10'].'</a>';
          }
          else{
          ...
          if($key != count($files) - 1){
            ...
            if($imgNext0 != ''){
              $navigation .= ' | <a class="move" href="'.makeUrl($imgNext0).'" id="buttonViewMoveLast" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveLast'].'</a>';
            }
            else{
...
////////////////////////////////////////////
    ...
    if($path != ''){
      ...
      $pathToFolder = implode("/", $pathToFolderArray);
      echo '&nbsp;↳ ../ <a href="'.makeUrl($pathToFolder.'/').'" id="buttonFolderBack" onClick="window.open(this.href, \'_self\');">'.$text['back'].'</a><br>';
    }
    else{ //root
      echo '<table><tr><td>↑ Aktuální složka</td><td>Nápověda vpravo nahoře ↗</td></tr>';
      echo '<tr><td>↓ Procházení adresářů a složek</td><td>Osobní stránky vpravo dole ↘</td></tr></table>';
    }
    echo '<hr>';
...
////key shortcuts
//file browsing
jwerty.key('left', function(){ //move -1 in album
  if(IS_FOLDER === false){
    $('#buttonViewMoveLeft').trigger("click");
  }
});
jwerty.key('right', function(){ //move +1 in album
  if(IS_FOLDER === false){
    $('#buttonViewMoveRight').trigger("click");
  }
});
jwerty.key('shift+right', function(){ //move +10 in album
  if(IS_FOLDER === false){
    $('#buttonViewMoveJumpRight').trigger("click");
  }
});
jwerty.key('shift+left', function(){ //move -10 in album
  if(IS_FOLDER === false){
...
//folder browsing
jwerty.key('shift+home', function(){ //move to root folder
  $('#buttonFolderRoot').trigger("click");
});
jwerty.key('shift+up', function() { //move one folder back
  $('.buttonFolderBack').trigger("click"); //its class! Sometimes there is more then one link to get back
});
jwerty.key('shift+down', function() { //move on previous page
  javascript:self.history.back();
});
//common
jwerty.key('shift+h', function(){ //open/close help
