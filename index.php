...
$videoEx = array('mp4', 'ogv', 'webm', 'avi', 'flv', '3gp', 'mkv');
...
define('PRES_DEFAULT', 7);
//  if it is on last file in folder, should it go to first one?
...
//translation
 ...
 'imgMoveNext10'       => '+10 >',
 'imgMoveLast'         => '|>',
 'presTurnOn'          => 'Zapnout prezentaci',
 'presTurnOff'         => 'Vypnout prezentaci',
 'presSeconds'         => 'Čas zobrazení obrázku: ',
 'presTextMovingNext'  => "Přesouvám se na další soubor",
 'presTextWaitOnePt1'  => "Další soubor za",
 'presTextWaitOnePt2'  => "vteřinu",
 'presTextWaitTwoThreeFourPt1' => "Další soubor za",
 'presTextWaitTwoThreeFourPt2' => "vteřiny",
 'presTextWaitFiveOrMorePt1'   => "Další soubor za",
 'presTextWaitFiveOrMorePt2'   => "vteřin",
 'errorCheckConnectionFailed'  => "Nepodařilo se navázat připojení k fotogalerii. Poslední načtení:"
);
//                       SETTINGS END                          //
/////////////////////////////////////////////////////////////////
//functions
...
function makeUrl($path){
  if(!preg_match("(/$)", $path) && $_GET['pres'] > 0){ //link is to file && isset presentation
    $pres = "&pres=".intval($_GET['pres']); //add presentatin param
  }
  return '?path='.urlencode(preg_replace("(^/|\./)", "", $path)).$pres;
}
/*
...
table#structure tr td:nth-child(4){
  text-align: center;
}
table#structure tr td{
  padding: 0 6px 0 6px;
...
h2{
  ...
  <div class="part">
    <h3>Vysvětlivky:</h3>
    <ul>
     <li><b>Soubor</b>: obrázek či video</li>
     <li><b>Složka</b>: nějaká struktura souborů (např. album). Lze si představit jako alba. Několik alb je několik složek, ve kterých něco je.</li>
     <li><b>Odkaz</b>: modrý text, na který když se klikne, tak to zobrazí danou složku nebo soubor. Když se na něj najede myší, obvykle to zobrazí i nějaký text. Třeba <a href="#" title="Pozdraven buď Pán Ježíš Kristus">tady</a></li>
     <li><b>KB</b>: Kilobajt (jednotka určující velikost souboru)</li>
     <li><b>MB</b>: Megabajt (jednotka určující velikost souboru)</li>
     <li><b>GB</b>: Gigabajt (jednotka určující velikost souboru)</li>
     <li><b>Stáhnout</b>: přenést soubor z jednoho místa na druhý - v tomto případě to je přenesení videa z Internetu do počítače kde se dá lépe přehrát.</li>
    </ul>
  </div>
  <div class="part">
    <h3><a href="#">Domů</a> / <a href="#">2014</a> / <a href="#">hory</a> / <a href="#">video</a></h3>
    <p>
      Cesta k dané složce. Kliknutím na "Domů" <b class="key">SHIFT</b>+<b class="key">Home</b> se dostaneš do úplně první složky, kliknutím na "2014" se dostaneš do složky 2014. Poslední položka u těchto lomítek je vždy složka, ve které se nacházíš. Na předchozí složku se dostaneš kliknutím na "hory" <b class="key">Backspace</b> nebo <b class="key">Esc</b>.
    </p>
    <h3><a href="#">Domů</a> / <a href="#">hory</a> / <a href="#">video</a> / soubor.jpg</h3>
    <p>
      Pokud prohlížíš konkrétní soubor, cesta navíc zobrazuje i samotný název souboru. Předchozí složka je nyní "Video" <b class="key">Backspace</b> nebo <b class="key">Esc</b>.
    </p>
  </div>
  <div class="part">
    <h3>Pohyb mezi složkami</h3>
      <table><tr><th>&nbsp;</th><th>Název</th><th>Velikost</th><th>Vložil</th><th>Datum vložení</th></tr>
        <tr><td>&nbsp;↳ </td><td><a href="#">letna/</a></td><td>&nbsp;</td></tr>
        <tr><td>&nbsp;↳ </td><td><a href="#">video/</a></td><td>&nbsp;</td></tr>
        <tr><td>&nbsp;</td><td><a href="#">2014-02-16 12.27.15.jpg/</a><td>1.65 MB</td></td><td>72605</td><td>28.04.2014 11:07:29</td></tr>
        <tr><td>&nbsp;</td><td><a href="#">2014-02-16 14.53.10.jpg/</a><td>995.26 KB</td></td><td>72605</td><td>28.04.2014 11:07:31</td></tr>
        <tr><td>&nbsp;</td><td><a href="#">2014-02-18 16.50.21.jpg/</a><td>1.37 MB</td></td><td>72605</td><td>28.04.2014 11:07:32</td></tr>
  ...
  <div class="part">
    <h3>Pohyb mezi soubory</h3>
    <div class="navigation">
      <a class="move" href="#"><|</a> | <a class="move" href="#">< -10</a> | <a class="move" href="#">< -1</a> (19/40) <a class="move" href="#">+1 ></a> | <a class="move" href="#">+10 ></a> | <a class="move" href="#">|></a>
    </div>
   <table>
    <tr>
      <td><a href="#"><|</a></td>
      <td>označuje přesun na první soubor</td>
      <td><b class="key">Home</b></td>
    </tr>
    <tr>
      <td><a href="#"><-10</a> </td>
      <td>je skok o 10 souborů zpět</td>
      <td><b class="key">SHIFT</b>+<b class="key">←</b></td>
    </tr>
    <tr>
      <td><a href="#"><-1</a></td>
      <td>posun o jeden soubor zpět</td>
      <td><b class="key">←</b></td>
    </tr>
    <tr>
      <td><a href="#">+1></a></td>
      <td>posun na další soubor</td>
      <td><b class="key">→</b></td>
    </tr>
    <tr>
      <td><a href="#">+10></a></td>
      <td>skok o 10 souborů vpřed</td>
      <td><b class="key">SHIFT</b>+<b class="key">→</b></td>
    </tr>
    <tr>
      <td><a href="#">|></a></td>
      <td>posun na poslední soubor</td>
      <td><b class="key">End</b></td>
    </tr>
   </table>
   <p>
   Čísla vedle názvu souboru říkají, kolikátý si prohlížíš soubor a z kolika celkem<br>
   Pokud se zobrazí obrázek, lze na něj kliknout <b class="key">Enter</b> a tím se přepnout do náhledu přes celou obrazovku.
  </p>
  <p>
   Někdy se objeví i video k přehrání, případně ke stažení.
  </p>
  </div>
  <div class="part">
    <h3>Prezentace</h3>
...
if(CHECK_CONNECTION > 0){
  echo '<h2 id="checkConnection">'.$text['errorCheckConnectionFailed'].' <span></span></h2>'.PHP_EOL;
}
////////////////////////////////////////////
//       Full pathto file / folder       //
////////////////////////////////////////////
  $pathArray = explode("/", $path);
  echo '<h3 id="fullPath">';
  if(BEFORE_PATH_LINK != ''){
    if(preg_match("(^(http:\/\/)|(\/))", BEFORE_PATH_LINK)){
      if(BEFORE_PATH_TEXT == ''){
        echo '<a id="'.$id++.'" href="'.BEFORE_PATH_LINK.'" onClick="window.open(this.href, \'_self\');">'.BEFORE_PATH_LINK.'</a>';
      }
      else{
        echo '<a id="'.$id++.'" href="'.BEFORE_PATH_LINK.'" onClick="window.open(this.href, \'_self\');">'.BEFORE_PATH_TEXT.'</a>';
      }
    }
    else{
      echo BEFORE_PATH_TEXT;
    }
    echo ' / ';
  }
...
*/
    ...
    if($key > 0){
      ...
      if($key == (count($pathArray) - $minus)){ //move back
        ...
        echo '<a id="'.$id++.'" href="'.makeUrl($pathToFolder.'/').'" onClick="window.open(this.href, \'_self\');">'.end($pathToFolderArray).'</a> / ';
      }
    }
  }
  if(IS_FOLDER == false){
  ...
  echo '<script>var firstFile = '.$id.'</script>'.PHP_EOL;
////////////////////////////////////////////
//            file browsing               //
////////////////////////////////////////////
  if(IS_FOLDER == false){
...
#pres button[type=submit]:focus{
  cursor: pointer;
}
</style>
<?php
    if(PRES_ENABLED == true){
      //presentation
      if($_GET['pres'] > 0){
        echo '<a href="'.makeUrl($path).'&pres=0" class="buttonPresentation" onClick="window.open(this.href, \'_self\');">'.$text['presTurnOff'].'</a>. <span id="presText"><span id="presTextLeft"></span></span>.';
      }
      else{
echo '<form method="GET" id="pres">
  <input type="hidden" name="path" value="'.$path.'">
   '.$text['presSeconds'].'
  <input name="pres" type="number" min="1" value="'.PRES_DEFAULT.'">
  <button type="submit" class="buttonPresentation" title="Zapnout automatický posun souborů"onclick="submit()">'.$text['presTurnOn'].'</button>
</form>'.PHP_EOL;
      }
    }
    $pathArray = explode("/", $path);
    ...
    if(is_array($files)){
      ...
      foreach($files as $key=>$value){
        if($path == str_replace("./", "", $value)){
          $navigation .= '<div class="navigation">'.PHP_EOL;
          //move to first file in folder
          if($key != 0){
            $imgBefore0 = $files[0];
            $navigation .= '<a class="move buttonViewMoveFirst" href="'.makeUrl($imgBefore0).'" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveFirst'].'</a> | '.PHP_EOL;
          }
          else{
            $navigation .= preg_replace("(.)", '&nbsp;', $text['imgMoveFirst']).'&nbsp;&nbsp;&nbsp;'.PHP_EOL;
          }
          //move 10 files back in folder
          $imgBefore10 = $files[$key-10];
          if($imgBefore10 != ''){
            $navigation .= '<a class="move buttonViewMoveJumpLeft" href="'.makeUrl($imgBefore10).'" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveBefore10'].'</a> | '.PHP_EOL;
          }
          else{
            $navigation .= preg_replace("(.)", '&nbsp;', $text['imgMoveBefore10']).'&nbsp;&nbsp;&nbsp;'.PHP_EOL;
          }
          //move 1 file back in folder
          $imgBefore = $files[$key-1];
          if($imgBefore != ''){
            $navigation .= '<a class="move buttonViewMoveLeft" href="'.makeUrl($imgBefore).'" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveBefore1'].'</a>'.PHP_EOL;
          }
          else{
            $navigation .= preg_replace("(.)", '&nbsp;', $text['imgMoveBefore1']).PHP_EOL;
          }
          //number of file / total files in folder
          $navigation .= '&nbsp;('.($key+1).'/'.$filesCount.')&nbsp;'.PHP_EOL;
          //move 1 file next in folder
          $imgNext = $files[$key+1];
          if($imgNext != ''){
            $navigation .= '<a class="move buttonViewMoveRight" href="'.makeUrl($imgNext).'" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveNext1'].'</a>'.PHP_EOL;
          }
          else{
            $navigation .= '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.preg_replace("(.)", '&nbsp;', $text['imgMoveNext1']).PHP_EOL;
          }
          //move 10 files next in folder
          $imgNext10 = $files[$key+10];
          if($imgNext10 != ''){
            $navigation .= '&nbsp;|&nbsp;<a class="move buttonViewMoveJumpRight" href="'.makeUrl($imgNext10).'" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveNext10'].'</a>'.PHP_EOL;
          }
          else{
            $navigation .= '&nbsp;&nbsp;&nbsp;'.preg_replace("(.)", '&nbsp;', $text['imgMoveNext10']).PHP_EOL;
          }
          //move to last file in folder
          if($key != count($files) - 1){
            $imgNext0 = $files[(count($files) - 1)];
            if($imgNext0 != ''){
              $navigation .= ' | <a class="move buttonViewMoveLast" href="'.makeUrl($imgNext0).'" onClick="window.open(this.href, \'_self\');">'.$text['imgMoveLast'].'</a>'.PHP_EOL;
            }
            else{
              $navigation .= '&nbsp;&nbsp;&nbsp;'.preg_replace("(.)", '&nbsp;', $text['imgMoveLast']).PHP_EOL;
            }
          }
    ...
    if(preg_match(RE_ALLOWED_EX_IMG, $path)){
      ...
      echo '<a href="'.$pathToImg.'" class="buttonImageOpen" onClick="window.open(this.href, \'_blank\');"></a>'.PHP_EOL; //open via shortcut
      echo '<a href="'.$pathToImg.'" target="_blank"><img src="'.$pathToImg.'"></a>'.PHP_EOL; //open via direct click
    }
    //print video
    elseif(preg_match(RE_ALLOWED_EX_VIDEO, $path)){
      //create video tag
      if(preg_match(RE_ALLOWED_EX_VIDEO_PLAY, $path)){
        echo '<video src="'.$path.'" controls>Váš prohlížeč nepodporuje přehrávání videa. <br>Nainstalujte novější verzi prohlížeče, nebo stáhněte <a href="www.google.com/chrome" target="_blank" title="Chrome ke stažení">jiný</a></video>';
      }
      else{
        echo 'Jedná se o video ale není<br>možné je přehrát v přehrávači.';
      }
...
////////////////////////////////////////////
    ...
    if($countFolders > 0 && $folders[0] != ''){
      ...
      foreach($folders as $key=>$value){
        ...
        echo '<tr><td>↳</td><td><a id="'.$id++.'" href="'.makeUrl($value.'/').'" onClick="window.open(this.href, \'_self\');">'.end($pathArray).'/</a></td>';
        if($countFiles > 0){
          echo '<td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td>';
        }
        echo '</tr>'.PHP_EOL;
...
if(HELP_ENABLED == true){
  ...
  if(isset($_GET['help'])){
    echo '<a href="'.makeUrl($path).'" title="Zpět na předchozí stránku" class="buttonHelp" onClick="window.open(this.href, \'_self\');">'.$text['back'].'</a>'.PHP_EOL;
  }
  else{
    if(IS_FOLDER){
      echo '<input type="search" id="search" placeholder="Filtr souborů" onClick="filter()"/> '.PHP_EOL; //onClick because of click on X button in input
    }
...
* "buttons" are changed from id to class
- removed head (root & back links)
* completely rewrite selecting in structure (using local storage)
...
text["presTextWaitOnePt2"] = "'.$text['presTextWaitOnePt2'].'";
text["presTextWaitTwoThreeFourPt1"] = "'.$text['presTextWaitTwoThreeFourPt1'].'";
text["presTextWaitTwoThreeFourPt2"] = "'.$text['presTextWaitTwoThreeFourPt2'].'";
text["presTextWaitFiveOrMorePt1"] = "'.$text['presTextWaitFiveOrMorePt1'].'";
text["presTextWaitFiveOrMorePt2"] = "'.$text['presTextWaitFiveOrMorePt2'].'";
';
?>
...
jwerty.key('left', function(){
  ...
  else{ //move -1 in album
    $('.buttonViewMoveLeft').trigger("click");
  }
});
jwerty.key('right', function(){
  if(IS_FOLDER){
    ...
    $('.buttonViewMoveRight').trigger("click");
  }
});
jwerty.key('shift+right', function(){
  if(IS_FOLDER){
  }
  else{ //move +10 in album
    $('.buttonViewMoveJumpRight').trigger("click");
  }
});
...
jwerty.key('home', function() {
  if(IS_FOLDER){ //select first file/folder
    findItem('first');
  }
  else{ //move to start in album
    $('.buttonViewMoveFirst').trigger("click");
  }
});
jwerty.key('home, home', function() {
  if(IS_FOLDER){ //move select to "root" link
    //@todo
    //findItem('first');
  }
});
jwerty.key('end', function(){
  if(IS_FOLDER){ //move to last file in folders
    findItem('last');
  }
  else{ //move to end in album
...
jwerty.key('space', function(){
  ...
  else{ //start/stop presentation
    $('.buttonPresentation').trigger("click");
  }
});
jwerty.key('up', function(){
  if(IS_FOLDER){
    findItem('before'); //select before visible item
    moveWindow('up'); //move window if item is not visible
  }
  else{
...
jwerty.key('down', function(){
  ...
  if(IS_FOLDER){ //select next visible item
    findItem('next');
    moveWindow('down');
  }
  else{ //decrease seconds in presentation (before start)
    $('form#pres input[type=number]').val((parseInt($('form#pres input[type=number]').val()) - 1));
  }
});
jwerty.key('enter', function(){
  if(IS_FOLDER){ //open folder
    $("#"+$.FCache.get('item')).trigger("click");
  }
  else{ //open image in fullscreen
    $('.buttonImageOpen').trigger("click");
  }
});
jwerty.key('up/down', function(){
  if(IS_FOLDER){
    event.preventDefault();  //browser: move window up and down
    if($("#search").is(":focus")){
      $("#search").focusout(); //unfocus from filter (if someone want to move select in folder)
    }
  }
  else{
  }
...
$(function(){
  $('#search').keyup(function(){ //if filter is focused automaticaly run filter on any new char
    if($("#search").is(":focus")){
      filter();
    }
  });
...
/*
 * Fully-In-Viewport - Selector Jquery identificar elementos completamente mostrados en pantalla
 * @author http://www.appelsiini.net/projects/viewport
 */
...
function findItem(action){
  ...
  if(action === 'referer'){
    ...
    if(next === undefined || next <= firstFile){ //referer is not defined OR you went to some folder
      ...
      console.log("referer was successfull. Next: " + next);
    }
  }
  else{
  var i = 1;
  ...
  if(action === 'first'){ //set as selected first file and search "next"
    ...
    var selected = next = $.FCache.get('item'); //save selected item - for last/first item
  }
  if(action === 'next'){
    next++;
  }
...
function presEditText(left){
  switch(left){
    case 0: $('#presTextLeft').html(text['presTextMovingNext']); break;
    case 1: $('#presTextLeft').html(text['presTextWaitOnePt1'] + " " + left + " " + text['presTextWaitOnePt2']); break;
    case 2: case 3: case 4: $('#presTextLeft').html(text['presTextWaitTwoThreeFourPt1'] + " " + left + " " + text['presTextWaitTwoThreeFourPt2']); break;
...
$(document).ready(function(){
  ...
  setInterval(function(){//enable "CRON"
    ...
    if(pres > 0){
      ...
      presTmp++;
      presEditText(pres - presTmp) //edit text above image (seconds to another file)
      if(presTmp >= pres){
        presTmp = 0;
        if ($('.buttonViewMoveRight').length){
          console.log("next");
          $('.buttonViewMoveRight').trigger("click");
        }
        else{
      ...
      if(CheckConnectionNext > CHECK_CONNECTION){
        ...
        $.ajax({
          ...
          success: function(data){
            $( "#checkConnection span" ).html(data);
            $( "#checkConnection" ).css( "display", "none");
          },
          error: function(){
            $( "#checkConnection" ).css( "display", "block");
          }
        });
      }
      else{
